...
urlpatterns = [
    ...
    # url(r'board/(?P<pk>\d+)/$', views.board_topic, name='board_topic'),
    url(r'board/(?P<pk>\d+)/$', views.TopicListView.as_view(), name='board_topic'),
    ...
    # url(r'^board/(?P<pk>\d+)/topic/(?P<topic_pk>\d+)/$', views.topic_posts, name='topic_posts'),
    url(r'^board/(?P<pk>\d+)/topic/(?P<topic_pk>\d+)/$', views.PostListView.as_view(), name='topic_posts'),
